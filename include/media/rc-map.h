...
#define RC_PROTO_BIT_NEC_2HDR_40BIT	BIT_ULL(RC_PROTO_NEC_2HDR_40BIT)
#define RC_PROTO_BIT_NEC_FULL_40BIT	BIT_ULL(RC_PROTO_NEC_FULL_40BIT)
#define RC_PROTO_BIT_NEC_FULL_48BIT	BIT_ULL(RC_PROTO_NEC_FULL_48BIT)
